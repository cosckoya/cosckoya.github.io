...
2. **Cloud** - `docs/cloud/` - AWS, Azure, GCP with sub-sections
3. **DevOps** - `docs/devops/` - Git workflows, CI/CD, GitHub Actions
4. **Container** - `docs/containerization/` - Docker, Kubernetes, Helm
5. **Hack** - `docs/hack/` - OSINT, pentesting, security research
6. **Tools** - `docs/tools/` - CLI tools, editors, utilities
...
2. Add entry to the section's `SUMMARY.md` file (relative path)
3. Test with `make serve` to verify navigation works
4. Run `make test` to validate build and hooks
5. Commit changes
