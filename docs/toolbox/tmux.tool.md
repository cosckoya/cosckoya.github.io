...
- **[TPM](https://github.com/tmux-plugins/tpm)** — Plugin manager (essential)
...
- **[tmux-sensible](https://github.com/tmux-plugins/tmux-sensible)** — Sensible defaults everyone should use
- **[tmux-yank](https://github.com/tmux-plugins/tmux-yank)** — System clipboard integration

**Notable configs & themes:**
- **[gpakosz/.tmux](https://github.com/gpakosz/.tmux)** — Most popular tmux config (12k+ stars)
- **[tmux-themepack](https://github.com/jimeh/tmux-themepack)** — Status bar themes
- **[dracula/tmux](https://github.com/dracula/tmux)** — Dracula theme status bar
- **[catppuccin/tmux](https://github.com/catppuccin/tmux)** — Catppuccin theme

**Session managers:**
- **[tmuxinator](https://github.com/tmuxinator/tmuxinator)** — YAML-defined project layouts
- **[tmuxp](https://github.com/tmux-python/tmuxp)** — Python-based session manager (works with tmuxinator files)
